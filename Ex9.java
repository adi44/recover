...
public Ex9()
{
    ...
    m[0] = new ImageIcon("S1.png");
    m[1] = new ImageIcon("S2.png");
    m[2] = new ImageIcon("S3.png");
    l = new JLabel();
...
public  void actionPerformed(ActionEvent e)
{
  ...
  if(e.getSource()==b3){
    try {
      ...
      AudioInputStream inputStream = AudioSystem.getAudioInputStream(Question10.class.getResourceAsStream("mg.wav"));
